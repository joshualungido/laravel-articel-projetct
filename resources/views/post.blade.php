<x-layout>
    ...
    {{-- <article class="py-8 max-w-screen-md border-gray-300">
        ...
        <div>
            By
            <a href="/authors/{{ $post->author->username }}" class='hover:underline text-base text-gray-5'>{{ $post->author->name }}</a>
            in
            <a href="/categories/{{ $post->category->slug }}" class='hover:underline text-base text-gray-5'>{{ $post->category->name }}</a> | 
